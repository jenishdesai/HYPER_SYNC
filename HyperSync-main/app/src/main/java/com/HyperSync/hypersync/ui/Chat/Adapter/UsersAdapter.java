...
public class UsersAdapter extends RecyclerView.Adapter<UsersAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        FirebaseDatabase.getInstance().getReference("Data").child(empl.getCompany()).child("Chats").child(FirebaseAuth.getInstance().getUid() + users.getUserId()).orderByChild("timestamp").limitToLast(1).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
